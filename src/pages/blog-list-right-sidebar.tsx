...
export default function BlogListRightSidebar({ posts }: Props) {
  const categories = [
  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-6 py-8">
      <Head><title>Rossy Resina — Blog listado con barra derecha</title></Head>
      <nav className="text-sm text-gray-600 mb-4">
        <Link className="hover:underline" href="/">Inicio</Link>
        <span className="mx-2">/</span>
        <span className="font-medium text-gray-800">Blog · listado barra derecha</span>
      </nav>
